...
parser.add_argument('--exp', type=str, default='Co_SegNet_', help='exp_name')
...
if __name__ == "__main__":
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            masked_loss_1 = loss_mask(y_sig_1_u, y_sig_2_u, critic_segs_1)
            ...
            masked_loss_2 = loss_mask(y_sig_2_u, y_sig_1_u, critic_segs_2)
            ...
            if iter_num >= 800 and iter_num % 100 == 0:
                model_1.eval()
                if args.dataset_name == "LA":
                    dice_sample_1 = test_patch.var_all_case_cosegnet(model_1, num_classes=num_classes,
