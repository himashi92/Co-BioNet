...
parser.add_argument('--mu', type=float, default=0.005, help='weight to balance generator adversarial loss')
parser.add_argument('--t_m', type=float, default=0.3, help='mask threashold')
