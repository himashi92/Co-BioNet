...
def test_all_case(model_name, num_outputs, model_1, model_2, image_list, num_classes, patch_size=(112, 112, 80), stride_xy=18,
    ...
    for image_path in loader:
        ...
        prediction_1, score_map_1 = test_single_case_first_output(model_1, image, stride_xy, stride_z, patch_size,
    ...
    with open(test_save_path + '../{}_performance_best.txt'.format(model_name), 'w') as f:
