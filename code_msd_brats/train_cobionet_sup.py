...
parser.add_argument('--labelnum', type=int, default=387, help='trained samples')
parser.add_argument('--seed', type=int, default=1337, help='random seed')
parser.add_argument('--consistency', type=float, default=0.8, help='consistency_weight')
...
parser.add_argument('--t_m', type=float, default=0.25, help='mask threashold')
...
if __name__ == "__main__":
    ...
    trainloader = DataLoader(db_train, shuffle=True, num_workers=2, pin_memory=True, worker_init_fn=worker_init_fn, batch_size=args.batch_size)
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            loss_seg_dice_1 = criterion(y_all_1, label_batch)

            y_all_2 = torch.sigmoid(model_2(volume_batch))

            loss_seg_dice_2 = criterion(y_all_2, label_batch)
            ...
            g_critic_segs_1_2 = torch.sigmoid(critic_1(label_batch.float()))
            ...
            g_critic_segs_2_2 = torch.sigmoid(critic_2(label_batch.float()))
            ...
            if iter_num >= 800 and iter_num % 100 == 0:
                ...
                dice_sample_1 = test_patch_msd_brats.var_all_case(model_1, valloader, patch_size=patch_size, save_result=False, test_save_path=None)
                ...
                dice_sample_2 = test_patch_msd_brats.var_all_case(model_2, valloader, patch_size=patch_size, save_result=False, test_save_path=None)
